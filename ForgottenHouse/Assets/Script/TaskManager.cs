...
public class TaskManager : MonoBehaviour
{
    ...
    public void TaskCompleted()
    {
        ...
        {
            _door1Opened = true;
            if (door1 != null) door1.UnlockDoor();
            if (pillBox1 != null) pillBox1.Appear();
            Debug.Log("[TaskManager] Door 1 unlocked!");
        }
        ...
        {
            _door2Opened = true;
            if (door2Left != null) door2Left.UnlockDoor();
            if (door2Right != null) door2Right.UnlockDoor();
            if (pillBox2 != null) pillBox2.Appear();
            Debug.Log("[TaskManager] Door 2 unlocked!");
        }
        ...
        {
            _exitOpened = true;
            if (exitGateLeft != null) exitGateLeft.UnlockDoor();
            if (exitGateRight != null) exitGateRight.UnlockDoor();
            if (exitGateTrigger != null) exitGateTrigger.Activate();
            if (completionUI != null)
                StartCoroutine(ShowCompletionUI());
            Debug.Log("[TaskManager] Exit unlocked!");
        }
    }
    IEnumerator HideCompletionUI()
    {
